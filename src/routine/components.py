...
# from src.common import remote_info
...
class SkillCombination(Command):
    ...
    _display_name = 'Skill Combination'
...
#TODO: add assets, add new channel status configs, remote_info
...
# TODO: Add remote_info
class DailyCombination(Command):
    """ go to target channel """
    _display_name = 'Daily Combination'
